...
(Use the "@s5blank@":http://github.com/geraldb/slideshow-s5-blank or "@s5themes@":http://github.com/geraldb/slideshow-s5-themes theme pack to create S5 slide shows.)
